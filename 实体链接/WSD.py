...
if __name__ == '__main__':
    ...
    # 对示例句子分词
    sent1 = ' 本品为梨形或扁球形，青色、黄色或红色，直径5-10cm，或更大，顶部及基部均凹陷；外皮薄，革质、果肉肉质，内果皮坚韧，分为5室，每室有种子2枚。气清香，味甜、微酸。'
    sent0='手机中国苹果iPhone手机频道为您提供苹果iPhone手机官方动态、苹果iPhone机型大全、苹果iPhone手机排行榜等信息,带您及时掌握苹果iPhone手机'
    sent='大家都热衷于买苹果手机'
    wsd_word = '苹果'
